...
// Custom cell renderer for confidence score with Orthodox styling
const ConfidenceCellRenderer = (params: any) => {
  ...
  return (
    <div 
      className={`orthodox-badge ${getConfidenceClass(confidence)}`}
...
// Custom cell renderer for image thumbnail with Orthodox styling
