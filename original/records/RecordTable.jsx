    ...
    <div ref={printRef} className="table-responsive">
      <Table striped bordered hover className="records-table mb-0" size="sm">
          ...
          <tr>
            {sortFields.map((field, index) => (
              ...
              <th 
                ...
                className={`sortable-header ${field.hideOnMobile ? 'd-none d-md-table-cell' : ''}`}
        ...
        <tbody>
          {isLoading ? (
            <tr>
              <td colSpan={sortFields.length + 1} className="text-center py-4">
            ...
            <tr>
              <td colSpan={sortFields.length + 1} className="text-center py-5">
