...
export const FIELD_DEFINITIONS = {
  [RECORD_TYPES.BAPTISM]: {
    ...
    tableColumns: [
      { field: 'fullName', headerName: 'Name', valueGetter: (params) => `${params.data.first_name} ${params.data.last_name}` },
      { field: 'birth_date', headerName: 'Birth Date', cellRenderer: 'dateRenderer' },
      { field: 'reception_date', headerName: 'Reception Date', cellRenderer: 'dateRenderer' },
  ...
  [RECORD_TYPES.MARRIAGE]: {
    ...
    tableColumns: [
      { field: 'groomName', headerName: 'Groom', valueGetter: (params) => `${params.data.fname_groom} ${params.data.lname_groom}` },
      { field: 'brideName', headerName: 'Bride', valueGetter: (params) => `${params.data.fname_bride} ${params.data.lname_bride}` },
      { field: 'mdate', headerName: 'Date', cellRenderer: 'dateRenderer' },
      { field: 'clergy', headerName: 'Clergy' }
    ],
    validationSchema: {
  ...
  [RECORD_TYPES.FUNERAL]: {
    ...
    tableColumns: [
      { field: 'fullName', headerName: 'Name', valueGetter: (params) => `${params.data.name} ${params.data.lastname}` },
      { field: 'deceased_date', headerName: 'Date of Death', cellRenderer: 'dateRenderer' },
      { field: 'burial_date', headerName: 'Burial Date', cellRenderer: 'dateRenderer' },
