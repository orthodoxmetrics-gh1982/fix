...
const SimplePageEditor: React.FC<SimplePageEditorProps> = ({ 
  ...
  // Simple Editor.js configuration
  const editorConfig: any = {
    holder: 'simple-enhanced-editor',
  ...
  const insertComponent = (componentId: string) => {
    ...
    if (component && editorRef.current) {
      // For now, just insert as raw HTML block
      // This is a simplified approach
      showNotification(`Component ${component.name} insertion coming soon`, 'info');
    }
