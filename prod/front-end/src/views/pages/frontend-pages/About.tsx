...
import Banner from '@/src/components/frontend-pages/about/banner';
import Process from '@/src/components/frontend-pages/about/process';
import KeyMetric from '@/src/components/frontend-pages/about/key-metric';
