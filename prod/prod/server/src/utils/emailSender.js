...
class EmailSender {
  ...
  constructor() {
    ...
    this.fromEmail = process.env.FROM_EMAIL || 'noreply@orthodoxmetrics_db.com';
    ...
    <body>
      <div class="container">
        ...
        <div class="footer">
          ...
          <p><strong>${translations.supportText}</strong> support@orthodoxmetrics_db.com</p>
        </div>
      </div>
    </body>
    </html>
  ...
  generateReceiptText(data) {
    ...
    text += `${translations.supportText} support@orthodoxmetrics_db.com\n`;
