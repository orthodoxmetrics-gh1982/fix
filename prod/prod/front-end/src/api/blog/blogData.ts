...
export const BlogPost: BlogPostType[] = [
  {
    id: chance.integer({ min: 1, max: 2000 }),
    title: 'Effective Church Management with Orthodox Metrics',
    content: 'Discover how Orthodox Metrics can streamline your church operations and improve community engagement.',
    coverImg: s1,
