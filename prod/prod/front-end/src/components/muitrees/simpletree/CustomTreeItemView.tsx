...
// import { useTreeItem2 } from '@mui/x-tree-view/useTreeItem2'; // Temporarily commented for build
...
const CustomTreeItem = React.forwardRef(function CustomTreeItem(props: any, ref) {
  ...
  const {
    ...
    status = {},
  } = {} as any; // = useTreeItem2({ id, itemId, children, label, disabled, rootRef: ref, ...other });
