...
const SliderData: SliderType[] = [
  {
    ...
    avatar: img1,
    subtext:
      'The Orthodox Metrics system has provided our church with an excellent way to manage our community, events, and member data efficiently and securely.',
  },
  {
    title: 'Minshan Cui',
    subtitle: 'Features avaibility',
    avatar: img2,
    subtext:
      'The quality of design is excellent, customizability and flexibility much better than the other products available in the market. I strongly recommend Orthodox Metrics to other churches.',
  },
  {
