...
📄 Parsing: server/database/check-database-connection.js
  Found 0 routes
📄 Parsing: server/database/database-manager.js
  Found 0 routes
...
📄 Parsing: server/debug/cleanup-expired-sessions.js
  Found 0 routes
📄 Parsing: server/debug/clear-old-sessions.js
  Found 0 routes
...
📄 Parsing: server/debug/reset-superadmin-password.js
  Found 0 routes
📄 Parsing: server/debug/run-fix.js
  Found 0 routes
...
📄 Parsing: server/legacy/phase0-ocr-system-test.js
  Found 0 routes
📄 Parsing: server/legacy/phase0-retry-failed-jobs.js
  Found 0 routes
...
📄 Parsing: server/migrations/002-database-architecture-separation.js
  Found 0 routes
📄 Parsing: server/models/kanbanBoard.js
  Found 0 routes
...
📄 Parsing: server/scrapers/utils/intelligent-validator.js
  Found 0 routes
📄 Parsing: server/scrapers/utils/url-validator.js
  Found 0 routes
...
📄 Parsing: server/scripts/setup-headlines-data.js
  Found 0 routes
📄 Parsing: server/scripts/setup-user-lockout.js
  Found 0 routes
...
📄 Parsing: server/setup/phase2-complete.js
  Found 0 routes
📄 Parsing: server/setup/phase2-master-runner.js
  Found 0 routes
...
❓ 🔗 POST   /admin/notifications/custom
...
❓ 🔗 GET    /current-user
    📁 server/routes/menuManagement.js:208
    💬 GET /menu-management/current-user - Get menu items for current logged-in user
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /dashboard/:churchId
    📁 server/routes/billing.js:557
    💬 GET /api/billing/dashboard/:churchId - Get billing dashboard data
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /data/chat/ChatData
    📁 server/routes/mock-apis.js:51
    💬 Mock chat data endpoint (for existing chat component)
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /data/gallery
    📁 server/routes/mock-apis.js:7
    💬 Mock gallery endpoint
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /data/postData
    📁 server/routes/mock-apis.js:18
    💬 Mock post data endpoint
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /data/users
    📁 server/routes/mock-apis.js:29
    💬 Mock users data endpoint
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /database-connection
    📁 server/routes/admin-test.js:16
    💬 Basic Tests
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /database-health
    📁 server/routes/adminSystem.js:125
    💬 Database Health Check
    🛡️  Middleware: Check
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /date/:date
    📁 server/routes/orthodoxCalendar.js:228
    💬 Get Orthodox calendar data for a specific date
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /deactivate
    📁 server/routes/maintenance.js:122
    💬 /
    🔗 33 references (4 frontend, 29 backend)

❓ 🔗 GET    /decisions
    📁 server/routes/autonomy.js:400
    💬 Get autonomous decisions
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 DELETE /delete/:id
    📁 server/routes/backup.js:241
    💬 DELETE /api/backup/delete/:id - Delete a backup
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /deploy/run
    📁 server/routes/ai.js:188
    💬 POST /api/ai/deploy/run - AI deployment automation
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /disclaimers/:language
    📁 server/routes/ocrSecure.js:188
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /discover
    📁 server/routes/componentDiscovery.js:15
    💬 /
    🔗 29 references (4 frontend, 25 backend)

❓ 🔗 GET    /documents
    📁 server/routes/nlp.js:235
    💬 Document Management
    🔗 46 references (5 frontend, 41 backend)

❓ 🔗 POST   /documents
    📁 server/routes/nlp.js:244
    🔗 46 references (5 frontend, 41 backend)

❓ 🔗 GET    /documents/:id
    📁 server/routes/nlp.js:279
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /documents/:id/analyze
    📁 server/routes/nlp.js:296
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /download/:env/:filename
    📁 server/routes/admin/backups.js:179
    💬 GET /api/backups/download/:env/:filename - Download a backup file
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /download/:id
    📁 server/routes/backup.js:212
    💬 GET /api/backup/download/:id - Download a backup
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /download/:sessionId/:format
    📁 server/routes/ocrSecure.js:138
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /dropdown-config
    📁 server/routes/dropdownOptions.js:14
    💬 GET /api/dropdown-config
    🔗 14 references (0 frontend, 14 backend)

❓ 🔗 GET    /dropdown-options/:column
    📁 server/routes/baptism.js:443
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /duplicate
    📁 server/routes/templates.js:675
    💬 /
    🔗 89 references (4 frontend, 85 backend)

❓ 🔗 POST   /e2e-upload
    📁 server/routes/admin-test.js:27
    💬 Full Integration Tests (placeholders for future implementation)
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /emergency
    📁 server/routes/maintenance.js:200
    💬 /
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /end-session
    📁 server/routes/jit-terminal.js:218
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /entity-extraction
    📁 server/routes/admin-test.js:22
    💬 Advanced Tests
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /events
    📁 server/routes/orthodoxCalendar.js:973
    💬 GET /api/liturgical-calendar/events - Get parish events
    🔗 281 references (4 frontend, 277 backend)

❓ 🔗 POST   /events
    📁 server/routes/orthodoxCalendar.js:763
    💬 POST /api/liturgical-calendar/events - Add parish event
    🔗 281 references (4 frontend, 277 backend)

❓ 🔗 GET    /events/:churchId
    📁 server/routes/orthodoxCalendar.js:1136
    💬 Get church events for a date range
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /execute
    📁 server/routes/bigbook.js:336
    💬 POST /api/bigbook/execute - Execute a file
    🔗 81 references (4 frontend, 77 backend)

❓ 🔗 POST   /execute-command
    📁 server/routes/globalOmai.js:91
    💬 Execute OMAI command
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /export
    📁 server/routes/kanbanSync.js:652
    💬 /
    🔗 1578 references (5 frontend, 1573 backend)

❓ 🔗 GET    /export/:churchId
    📁 server/routes/dashboard.js:367
    💬 Export dashboard data
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /export/all
    📁 server/routes/kanban/boards.js:372
    💬 GET /api/kanban/boards/export/all - Export all boards to markdown
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /extract-fields
    📁 server/routes/church/ocr.js:66
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /extraction/bulk
    📁 server/routes/public/entityExtraction.js:27
    💬 Bulk entity extraction for multiple jobs
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /extraction/review
    📁 server/routes/public/entityExtraction.js:24
    💬 Get jobs that need review
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /extraction/stats
    📁 server/routes/public/entityExtraction.js:21
    💬 Get extraction statistics for the church
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /fasting
    📁 server/routes/orthodoxCalendar.js:1098
    💬 Get fasting status for a date
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /feasts
    📁 server/routes/orthodoxCalendar.js:1086
    💬 Get feasts by date
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /feasts/search
    📁 server/routes/orthodoxCalendar.js:1161
    💬 Search feasts by name
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /field-mapping
    📁 server/routes/admin-test.js:35
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /fields-metadata
    📁 server/routes/permissions.js:34
    💬 ─── FIELDS METADATA ─────────────────────────────────────────────────────────
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /files
    📁 server/routes/backup.js:83
    💬 GET /api/backup/files - List backup files
    🛡️  Middleware: Check
    🔗 157 references (4 frontend, 153 backend)

❓ 🔗 GET    /filter-options
    📁 server/scrapers/frontend/church-directory-api.js:266
    💬 6. Get filter options for dropdowns
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /fix
    📁 server/routes/omai.js:113
    💬 POST /api/omai/fix - Fix endpoint for frontend compatibility
    🔗 233 references (4 frontend, 229 backend)

❓ 🔗 GET    /for-role/:role
    📁 server/routes/menuManagement.js:89
    💬 GET /menu-management/for-role/:role - Get visible menu items for a specific role
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /forecasts
    📁 server/routes/analytics.js:480
    💬 Get forecasts
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 USE    /friends
    📁 server/routes/social/index.js:13
    💬 Mount individual routes
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /frontend
    📁 server/routes/logs.js:437
    💬 POST /api/logs/frontend - Frontend logging endpoint
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /frontend/rebuild
    📁 server/routes/admin/services.js:333
    💬 POST /admin/services/frontend/rebuild - Trigger frontend rebuild (MUST be before generic route)
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /full-sync
    📁 server/routes/kanbanSync.js:85
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /funeral-records
    📁 server/routes/clientApi.js:219
    💬 Get funeral records
    🔗 18 references (13 frontend, 5 backend)

❓ 🔗 POST   /generate
    📁 server/routes/invoices.js:136
    💬 POST /api/invoices/generate - Generate invoice from service record
    🔗 3009 references (4 frontend, 3005 backend)

❓ 🔗 POST   /generate-and-commit
    📁 server/routes/omb.js:259
    💬 POST /api/omb/generate-and-commit - Generate code and commit to Git
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /generate-code
    📁 server/routes/omb.js:193
    💬 POST /api/omb/generate-code - Generate code from component
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /generate-doc
    📁 server/routes/omai.js:408
    💬 POST /api/omai/generate-doc - Documentation generation
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /generate-module
    📁 server/routes/omai.js:205
    💬 POST /api/omai/generate-module - Code generation
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /generate/:billingId
    📁 server/routes/invoicesMultilingual.js:149
    💬 Generate multilingual invoice PDF
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /generate/baptism/:id
    📁 server/routes/certificates.js:73
    💬 Generate baptism certificate
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /generate/marriage/:id
    📁 server/routes/certificates.js:290
    💬 Generate marriage certificate
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /generation-logs
    📁 server/routes/omb.js:292
    💬 GET /api/omb/generation-logs - Get code generation logs
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /global-images/public
    📁 server/routes/mock-apis.js:40
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /global/available
    📁 server/routes/templates.js:651
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /goals
    📁 server/routes/autonomy.js:413
    💬 Get autonomous goals
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /google-vision
    📁 server/routes/admin-test.js:18
    💬 Basic Tests
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /health
    📁 server/routes/admin/services.js:282
    💬 GET /admin/services/health - Get overall system health
    🛡️  Middleware: Check
    🔗 22 references (5 frontend, 17 backend)

❓ 🔗 POST   /image
    📁 server/routes/uploads.js:47
    💬 POST /api/uploads/image - Upload a single image
    🔗 709 references (8 frontend, 701 backend)

❓ 🔗 GET    /images
    📁 server/routes/images.js:48
    💬 Get all images
    🔗 77 references (8 frontend, 69 backend)

❓ 🔗 GET    /images/:id
    📁 server/routes/images.js:94
    💬 Get a single image by ID
    🔗 8 references (0 frontend, 8 backend)

❓ 🔗 DELETE /images/:id
    📁 server/routes/images.js:115
    💬 Delete an image
    🔗 8 references (0 frontend, 8 backend)

❓ 🔗 POST   /images/upload
    📁 server/routes/images.js:62
    💬 Upload images
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /import
    📁 server/routes/importRecords.js:195
    💬 /
    🛡️  Middleware: Check
    🔗 105 references (16 frontend, 89 backend)

❓ 🔗 GET    /improvements
    📁 server/routes/autonomy.js:426
    💬 Get improvement cycles
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /ingest-agent-output
    📁 server/routes/omai.js:605
    💬 POST /api/omai/ingest-agent-output - Webhook for AI agent memory ingestion
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /init
    📁 server/routes/templates.js:474
    💬 /
    🔗 133 references (4 frontend, 129 backend)

❓ 🔗 GET    /invoice/:invoiceId
    📁 server/routes/billing.js:257
    💬 GET /api/billing/invoice/:invoiceId - Get specific invoice with items
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /invoice/:invoiceId/generate
    📁 server/routes/billing.js:290
    💬 POST /api/billing/invoice/:invoiceId/generate - Generate invoice HTML/PDF
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /invoices/:churchId
    📁 server/routes/billing.js:201
    💬 GET /api/billing/invoices/:churchId - Get invoices for a church
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /jobs
    📁 server/routes/church/ocr.js:24
    💬 /
    🔗 65 references (4 frontend, 61 backend)

❓ 🔗 GET    /jobs/:jobId/details
    📁 server/routes/church/ocr.js:36
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /jobs/:jobId/entities
    📁 server/routes/public/entityExtraction.js:12
    💬 Get extracted entities for a specific job
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /jobs/:jobId/entities
    📁 server/routes/public/entityExtraction.js:15
    💬 Update extracted entities with user corrections
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /jobs/:jobId/export
    📁 server/routes/church/ocr.js:54
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /jobs/:jobId/extract
    📁 server/routes/public/entityExtraction.js:18
    💬 Manually trigger entity extraction for a job
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /jobs/:jobId/image
    📁 server/routes/church/ocr.js:42
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /jobs/:jobId/update
    📁 server/routes/church/ocr.js:48
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /kanban-auth
    📁 server/routes/debug.js:23
    💬 Debug endpoint to test kanban auth middleware
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /kanban/cards
    📁 server/routes/kanbanSync.js:316
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /kanban/cards/:id
    📁 server/routes/kanbanSync.js:359
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /kanban/cards/:id
    📁 server/routes/kanbanSync.js:393
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /kanban/cards/:id/move
    📁 server/routes/kanbanSync.js:441
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /kanban/columns
    📁 server/routes/calendar.js:699
    💬 Get Kanban columns
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /kanban/sync-status
    📁 server/routes/calendar.js:676
    💬 Get sync status
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /kanban/tasks
    📁 server/routes/calendar.js:559
    💬 Get Kanban tasks
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /languages
    📁 server/routes/headlines.js:155
    💬 GET /api/headlines/languages - Get available languages
    🔗 119 references (5 frontend, 114 backend)

❓ 🔗 POST   /learn-now
    📁 server/routes/omai.js:1207
    💬 POST /api/omai/learn-now - Manual trigger for immediate learning refresh
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /learning-status
    📁 server/routes/omai.js:1296
    💬 GET /api/omai/learning-status - Get current learning status and statistics
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /list
    📁 server/routes/admin/backups.js:39
    💬 GET /api/backups/list?env=dev|prod - List available backups
    🔗 277 references (4 frontend, 273 backend)

❓ 🔗 GET    /locales
    📁 server/routes/invoices.js:662
    💬 GET /api/invoices/locales - Get supported locales
    🔗 97 references (0 frontend, 97 backend)

❓ 🔗 GET    /locations
    📁 server/routes/dropdownOptions.js:97
    💬 GET /api/locations
    🔗 1358 references (9 frontend, 1349 backend)
...
❓ 🔗 GET    /logs
    📁 server/routes/autoLearningRoutes.js:57
    💬 /
    🔗 410 references (5 frontend, 405 backend)

❓ 🔗 DELETE /logs
    📁 server/routes/kanbanSync.js:588
    💬 /
    🔗 410 references (5 frontend, 405 backend)

❓ 🔗 POST   /logs/analyze
    📁 server/routes/ai.js:224
    💬 POST /api/ai/logs/analyze - AI log analysis
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /map-data
    📁 server/scrapers/frontend/church-directory-api.js:218
    💬 5. Get map data for visualization
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 PUT    /mark-all-read
    📁 server/routes/social/notifications.js:222
    💬 PUT /api/social/notifications/mark-all-read - Mark all notifications as read
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /marriage-records
    📁 server/routes/clientApi.js:149
    💬 Get marriage records
    🔗 14 references (9 frontend, 5 backend)

❓ 🔗 POST   /marriage-records
    📁 server/routes/clientApi.js:190
    💬 Create marriage record
    🔗 14 references (9 frontend, 5 backend)

❓ 🔗 GET    /memories
    📁 server/routes/omai.js:751
    💬 GET /api/omai/memories - Retrieve stored memories
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 DELETE /memories/:id
    📁 server/routes/omai.js:880
    💬 DELETE /api/omai/memories/:id - Delete a specific memory
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /memory-preview
    📁 server/routes/omai.js:1349
    💬 GET /api/omai/memory-preview - Get memory preview for mobile
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /menu-item
    📁 server/routes/menuPermissions.js:182
    💬 POST /api/menu-permissions/menu-item - Create a new menu item (super admin only)
    🔗 17 references (4 frontend, 13 backend)

❓ 🔗 PUT    /menu-item/:id
    📁 server/routes/menuPermissions.js:273
    💬 PUT /api/menu-permissions/menu-item/:id - Update menu item details
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /messages/:id
    📁 server/routes/social/chat.js:449
    💬 PUT /api/social/chat/messages/:id - Edit message
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /messages/:id
    📁 server/routes/social/chat.js:505
    💬 DELETE /api/social/chat/messages/:id - Delete message
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /messages/:id/react
    📁 server/routes/social/chat.js:557
    💬 POST /api/social/chat/messages/:id/react - Add/update reaction to message
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /messages/:id/react
    📁 server/routes/social/chat.js:609
    💬 DELETE /api/social/chat/messages/:id/react - Remove reaction from message
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /meta
    📁 server/routes/build.js:268
    💬 GET /api/build/meta - Get latest build metadata
    🔗 1453 references (4 frontend, 1449 backend)

❓ 🔗 GET    /meta-analysis
    📁 server/routes/autonomy.js:439
    💬 Get meta-cognitive analysis
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /metrics
    📁 server/routes/ai.js:44
    💬 GET /api/ai/metrics - Real-time AI metrics
    🔗 551 references (12 frontend, 539 backend)

❓ 🔗 GET    /metrics/:churchId
    📁 server/routes/dashboard.js:390
    💬 Get metrics
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /mock-ocr
    📁 server/routes/ocrVision.js:474
    💬 Mock OCR endpoint for testing without Google Vision API
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /models
    📁 server/routes/analytics.js:287
    💬 Get predictive models
    🔗 117 references (0 frontend, 117 backend)

❓ 🔗 POST   /models
    📁 server/routes/analytics.js:303
    💬 Create a new predictive model
    🔗 117 references (0 frontend, 117 backend)

❓ 🔗 PUT    /models/:id
    📁 server/routes/nlp.js:394
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /models/:id/predict
    📁 server/routes/analytics.js:373
    💬 Make a prediction using a model
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /models/:id/train
    📁 server/routes/analytics.js:339
    💬 Train a predictive model
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /month/:year/:month
    📁 server/routes/orthodoxCalendar.js:255
    💬 Get Orthodox calendar data for a month
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /mount
    📁 server/routes/admin/nfs-backup.js:351
    💬 POST /api/admin/nfs-backup/mount - Manually mount NFS share
    🔗 49 references (4 frontend, 45 backend)

❓ 🔗 USE    /nlp
    📁 server/routes/index.js:22
    🔗 5 references (4 frontend, 1 backend)

❓ 🔗 POST   /notes
    📁 server/routes/orthodoxCalendar.js:821
    💬 POST /api/liturgical-calendar/notes - Add/update user note
    🔗 126 references (5 frontend, 121 backend)

❓ 🔗 GET    /notification-counts
    📁 server/routes/debug.js:38
...
❓ 🔗 USE    /notifications
    📁 server/routes/social/index.js:14
    💬 Mount individual routes
    🔗 10 references (5 frontend, 5 backend)

❓ 🔗 GET    /notifications/:churchId
    📁 server/routes/dashboard.js:275
    💬 Get notifications
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /notifications/:id
    📁 server/routes/notifications.js:624
    💬 Dismiss notification
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /notifications/:id/read
    📁 server/routes/notifications.js:588
    💬 Mark notification as read
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /notifications/:notificationId/read
    📁 server/routes/dashboard.js:323
    💬 Mark notification as read
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /notifications/counts
    📁 server/routes/notifications.js:538
    💬 Get notification counts - /api/notifications/counts
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /notifications/preferences
    📁 server/routes/notifications.js:645
    💬 Get user notification preferences
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 PUT    /notifications/preferences
    📁 server/routes/notifications.js:660
    💬 Update user notification preferences
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 PUT    /notifications/read-all
    📁 server/routes/notifications.js:609
...
❓ 🔗 POST   /ocr-${lang}
    📁 server/routes/ocrVision.js:355
    💬 Authenticated routes (require login)
    🛡️  Middleware: Authenticate
    🔗 8 references (4 frontend, 4 backend)

❓ 🔗 POST   /ocr-gr
    📁 server/routes/ocr.js:336
    💬 Greek OCR endpoint
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /ocr-health
    📁 server/routes/ocr.js:558
    💬 Health check endpoint
    🛡️  Middleware: check
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /ocr-learning/reset
    📁 server/routes/ai.js:320
    💬 POST /api/ai/ocr-learning/reset - Reset auto-learning OCR
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /ocr-learning/rules
    📁 server/routes/ai.js:340
    💬 GET /api/ai/ocr-learning/rules - Get learning rules
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /ocr-learning/start
    📁 server/routes/ai.js:278
    💬 POST /api/ai/ocr-learning/start - Start auto-learning OCR
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /ocr-learning/status
    📁 server/routes/ai.js:256
    💬 GET /api/ai/ocr-learning/status - Auto-learning OCR status
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /ocr-learning/stop
    📁 server/routes/ai.js:300
    💬 POST /api/ai/ocr-learning/stop - Stop auto-learning OCR
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /ocr-pipeline/:churchId
    📁 server/routes/dashboard.js:91
    💬 Get OCR pipeline status
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /ocr-queue
    📁 server/routes/admin-test.js:21
    💬 Advanced Tests
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /ocr-ro
    📁 server/routes/ocr.js:291
    💬 Romanian OCR endpoint
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /ocr-ru
    📁 server/routes/ocr.js:246
    💬 Russian OCR endpoint
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /ocr-schema
    📁 server/routes/admin-test.js:17
    💬 Basic Tests
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /ocr-status
    📁 server/routes/ocrVision.js:458
    💬 Simple status endpoint for testing OCR service availability
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /ocr/process
    📁 server/routes/ai.js:115
    💬 POST /api/ai/ocr/process - AI OCR processing
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /ocr/result/:jobId
    📁 server/routes/ocrVision.js:384
    💬 Get OCR result by job ID
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /ocr/results
    📁 server/routes/ocrVision.js:435
    💬 List OCR results for user
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 USE    /omai
    📁 server/routes/index.js:18
    💬 Mount routes
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /omai/category/:category
    📁 server/routes/bigbook.js:1402
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /omai/discover
    📁 server/routes/bigbook.js:1311
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /omai/file/:fileId
    📁 server/routes/bigbook.js:1444
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /omai/file/:fileId/content
    📁 server/routes/bigbook.js:1477
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /omai/index
    📁 server/routes/bigbook.js:1364
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /omai/initialize
    📁 server/routes/bigbook.js:1283
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /omai/schedule
    📁 server/routes/bigbook.js:1522
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /omai/status
    📁 server/routes/bigbook.js:1342
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /omai/summary
    📁 server/routes/bigbook.js:1553
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /online
    📁 server/routes/social/friends.js:580
    💬 GET /api/social/friends/online - Get online friends
    🔗 13 references (0 frontend, 13 backend)

❓ 🔗 GET    /orthodox
    📁 server/routes/metrics.js:158
    💬 GET /api/metrics/orthodox - Get SaaS platform metrics
    🔗 25 references (16 frontend, 9 backend)

❓ 🔗 GET    /orthodox/churches
    📁 server/routes/metrics.js:193
    💬 GET /api/metrics/orthodox/churches - Get per-church usage metrics
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /orthodox/performance
    📁 server/routes/metrics.js:249
    💬 GET /api/metrics/orthodox/performance - Get system performance metrics
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /pages/register
    📁 server/routes/routes.js:56
    💬 Trigger page scan manually
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /parameters
    📁 server/routes/autonomy.js:365
    💬 Get autonomy parameters
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 PUT    /parameters
    📁 server/routes/autonomy.js:387
    💬 Update autonomy parameters
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /parse-enhanced
    📁 server/routes/church/ocr.js:60
    💬 /
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /pascha/:year
    📁 server/routes/orthodoxCalendar.js:677
    💬 GET /api/liturgical-calendar/pascha/:year - Get Pascha date for year
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /password
    📁 server/routes/auth.js:291
    💬 PUT /api/auth/password - Change user password
    🔗 45 references (4 frontend, 41 backend)

❓ 🔗 POST   /performance
    📁 server/routes/admin-test.js:59
    🔗 97 references (4 frontend, 93 backend)

❓ 🔗 POST   /permissions
    📁 server/routes/admin-test.js:51
    🔗 37 references (4 frontend, 33 backend)

❓ 🔗 GET    /permissions
    📁 server/routes/menuManagement.js:28
    💬 GET /menu-management/permissions - Get all menu permissions for all roles (super admin only)
    🔗 37 references (4 frontend, 33 backend)

❓ 🔗 PUT    /permissions
    📁 server/routes/menuManagement.js:139
    💬 PUT /menu-management/permissions - Update menu permissions for roles (super admin only)
    🔗 37 references (4 frontend, 33 backend)

❓ 🔗 GET    /plans
    📁 server/routes/billing.js:38
    💬 GET /api/billing/plans - Get all billing plans
    🔗 77 references (0 frontend, 77 backend)

❓ 🔗 GET    /plugin-results
    📁 server/routes/omai.js:382
    💬 GET /api/omai/plugin-results - Plugin results
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /pm2/processes
    📁 server/routes/admin/services.js:665
...
❓ 🔗 GET    /posts/:id
    📁 server/routes/social/blog.js:213
    💬 GET /api/social/blog/posts/:id - Get single blog post
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /posts/:id
    📁 server/routes/social/blog.js:421
    💬 PUT /api/social/blog/posts/:id - Update blog post
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /posts/:id
    📁 server/routes/social/blog.js:500
    💬 DELETE /api/social/blog/posts/:id - Delete blog post
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /posts/:id/comments
    📁 server/routes/social/blog.js:548
    💬 POST /api/social/blog/posts/:id/comments - Add comment to blog post
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /posts/:id/react
    📁 server/routes/social/blog.js:649
    💬 POST /api/social/blog/posts/:id/react - Add/update reaction to blog post
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /posts/:id/react
    📁 server/routes/social/blog.js:712
    💬 DELETE /api/social/blog/posts/:id/react - Remove reaction from blog post
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /predefined
    📁 server/routes/globalTemplates.js:16
    💬 /
    🔗 97 references (4 frontend, 93 backend)

❓ 🔗 PUT    /predefined/:recordType
    📁 server/routes/globalTemplates.js:40
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /predefined/:recordType/history
    📁 server/routes/globalTemplates.js:115
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /predefined/definitions
    📁 server/routes/templates.js:520
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /predefined/initialize
    📁 server/routes/templates.js:543
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 PUT    /preferences
    📁 server/routes/orthodoxCalendar.js:866
    💬 PUT /api/liturgical-calendar/preferences - Update user preferences
    🔗 13 references (4 frontend, 9 backend)

❓ 🔗 POST   /preprocess
    📁 server/routes/preprocessOcr.js:52
    💬 /
    🔗 29 references (0 frontend, 29 backend)

❓ 🔗 POST   /preprocess-path
    📁 server/routes/preprocessOcr.js:175
    💬 /
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /preview-code
    📁 server/routes/omb.js:226
    💬 POST /api/omb/preview-code - Preview generated code without writing files
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /preview/:billingId
    📁 server/routes/invoicesMultilingual.js:569
    💬 Get invoice data for preview
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /preview/:type/:id
    📁 server/routes/certificates.js:484
    💬 Preview certificate (base64 encoded)
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /process
    📁 server/routes/ocr.js:469
    💬 OCR processing endpoint with session validation (alternative endpoint)
    🔗 373 references (4 frontend, 369 backend)

❓ 🔗 POST   /process-all
    📁 server/routes/bigbook.js:499
    💬 POST /api/bigbook/process-all - Process all uploaded .md files
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /products
    📁 server/routes/ecommerce.js:128
    💬 GET /api/eCommerce/products - Get all products (mock data)
    🔗 953 references (4 frontend, 949 backend)

❓ 🔗 GET    /products/:id
    📁 server/routes/ecommerce.js:180
    💬 GET /api/eCommerce/products/:id - Get single product
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /profile
    📁 server/routes/auth.js:212
    💬 PUT /api/auth/profile - Update user profile information
    🔗 110 references (8 frontend, 102 backend)

❓ 🔗 POST   /profile
    📁 server/routes/upload.js:71
    💬 Profile image upload endpoint
    🔗 110 references (8 frontend, 102 backend)

❓ 🔗 GET    /profile
    📁 server/routes/user-profile.js:7
    💬 Get user profile data
    🔗 110 references (8 frontend, 102 backend)

❓ 🔗 PUT    /profile/images
    📁 server/routes/user-profile.js:164
    💬 Update profile images specifically
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /progress
    📁 server/routes/autoLearningRoutes.js:49
    💬 /
    🛡️  Middleware: authenticate
    🔗 45 references (4 frontend, 41 backend)

❓ 🔗 GET    /public
    📁 server/routes/admin/globalImages.js:312
    💬 Public route: Get all global images (profile and banner) for all users
    🔗 209 references (4 frontend, 205 backend)

❓ 🔗 POST   /public-ocr-${lang}
    📁 server/routes/ocrVision.js:364
    💬 Public tokenized upload routes (no login required)
    🛡️  Middleware: verify
    🔗 8 references (4 frontend, 4 backend)

❓ 🔗 GET    /queue
    📁 server/routes/provision.js:19
    💬 Get all provision queue entries (admin only)
    🔗 85 references (4 frontend, 81 backend)

❓ 🔗 GET    /raw/analyses
    📁 server/routes/nlp.js:479
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /raw/conversations
    📁 server/routes/nlp.js:461
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /raw/documents
    📁 server/routes/nlp.js:470
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /raw/sessions
    📁 server/routes/nlp.js:452
    💬 Raw data endpoints for debugging
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /readings
    📁 server/routes/orthodoxCalendar.js:1123
    💬 Get liturgical readings for a date
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /realtime/recent
    📁 server/routes/calendar.js:828
    💬 Get recent updates
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /realtime/tasks
    📁 server/routes/calendar.js:803
    💬 Server-Sent Events for real-time updates
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /recent
    📁 server/routes/churchSetupWizard.js:246
    💬 GET /api/churches/recent - Get recently added churches
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /record-transfer
    📁 server/routes/admin-test.js:43
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 USE    /records
    📁 server/routes/index.js:17
    💬 Mount routes
    🔗 18 references (13 frontend, 5 backend)

❓ 🔗 POST   /refresh
    📁 server/routes/componentDiscovery.js:255
    💬 /
    🔗 41 references (4 frontend, 37 backend)

❓ 🔗 GET    /report
    📁 server/scrapers/monitoring/dashboard-api.js:38
    💬 Get detailed monitoring report
    🔗 245 references (4 frontend, 241 backend)

❓ 🔗 GET    /reports
    📁 server/routes/analytics.js:195
    💬 Get all analytics reports
    🔗 82 references (5 frontend, 77 backend)

❓ 🔗 POST   /reports
    📁 server/routes/nlp.js:425
    🔗 82 references (5 frontend, 77 backend)

❓ 🔗 GET    /reports/:id
    📁 server/routes/analytics.js:211
    💬 Get a specific analytics report
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /request-access/:userId
    📁 server/routes/social/blog.js:797
    💬 POST /api/social/blog/request-access/:userId - Request access to private blog
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /request/:userId
    📁 server/routes/social/friends.js:128
...
❓ 🔗 PUT    /requests/:requestId
    📁 server/routes/social/friends.js:307
    💬 PUT /api/social/friends/requests/:requestId - Respond to friend request
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /reset
    📁 server/routes/autoLearningRoutes.js:79
    💬 /
    🔗 57 references (4 frontend, 53 backend)

❓ 🔗 GET    /responses/:questionnaireId
    📁 server/routes/bigbook.js:1229
    💬 GET /api/bigbook/responses/:questionnaireId - Get responses for a questionnaire
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /restore
    📁 server/routes/admin/backups.js:221
    💬 POST /api/backups/restore - Restore a backup
    🔗 77 references (4 frontend, 73 backend)

❓ 🔗 GET    /result/:jobId
    📁 server/routes/church/ocr.js:30
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /results
    📁 server/routes/autoLearningRoutes.js:65
    💬 /
    🔗 69 references (4 frontend, 65 backend)

❓ 🔗 POST   /retry-failed-jobs
    📁 server/routes/admin-test.js:68
    💬 Utility Actions
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /role/:role
    📁 server/routes/admin/menu-permissions.js:91
    💬 Get menu permissions for a specific role (admin use)
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /role/:role
    📁 server/routes/admin/menu-permissions.js:120
    💬 Update menu permissions for a role
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /routes
    📁 server/routes/routes.js:22
    💬 GET current routes & menu
    🔗 66 references (4 frontend, 62 backend)

❓ 🔗 POST   /routes
    📁 server/routes/routes.js:34
    💬 POST updated routes & menu, then re-scan pages
    🔗 66 references (4 frontend, 62 backend)

❓ 🔗 GET    /routes/stream
    📁 server/routes/routes.js:67
    💬 SSE for real-time file updates
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /rules
    📁 server/routes/autoLearningRoutes.js:72
    💬 /
    🛡️  Middleware: authenticate
    🔗 25 references (4 frontend, 21 backend)

❓ 🔗 POST   /run
    📁 server/routes/backup.js:170
    💬 POST /api/backup/run - Run a backup
    🔗 5 references (4 frontend, 1 backend)

❓ 🔗 POST   /run-agents
    📁 server/routes/omai.js:246
    💬 POST /api/omai/run-agents - Agent execution
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /run-plugins
    📁 server/routes/omai.js:354
    💬 POST /api/omai/run-plugins - Plugin execution
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /run-script
    📁 server/routes/runScript.js:111
    💬 POST /api/run-script - Execute a whitelisted script
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /run-stream
    📁 server/routes/build.js:295
    💬 GET /api/build/run-stream - Execute build with real-time streaming (EventSource)
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /saints
    📁 server/routes/orthodoxCalendar.js:1073
    💬 Get saints by date
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /saints/search
    📁 server/routes/orthodoxCalendar.js:1149
    💬 Search saints by name
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /sample
    📁 server/routes/invoices.js:117
    💬 GET /api/invoices/sample - Generate sample invoice data
    🔗 381 references (4 frontend, 377 backend)

❓ 🔗 GET    /sample/:recordType
    📁 server/routes/importRecords.js:374
    💬 /
    🔗 7 references (3 frontend, 4 backend)

❓ 🔗 POST   /save-extracted
    📁 server/routes/admin/globalImages.js:343
    💬 Save extracted images to profile/banner directory
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /save-wizard
    📁 server/routes/church/ocr.js:72
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /schedule
    📁 server/routes/maintenance.js:239
    💬 /
    🔗 437 references (4 frontend, 433 backend)

❓ 🔗 POST   /scrape
    📁 server/routes/church-scraper.js:39
    💬 Start a new scraping session
    🔗 9 references (0 frontend, 9 backend)

❓ 🔗 GET    /script-logs
    📁 server/routes/runScript.js:220
    💬 GET /api/script-logs - Get recent script execution logs (optional)
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /scripts
    📁 server/routes/runScript.js:86
    💬 GET /api/scripts - List available scripts
    🔗 41 references (4 frontend, 37 backend)

❓ 🔗 GET    /search
    📁 server/routes/componentDiscovery.js:146
    💬 /
    🔗 735 references (4 frontend, 731 backend)

❓ 🔗 GET    /season
    📁 server/routes/orthodoxCalendar.js:1110
    💬 Get liturgical season
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /secure/results/:jobId
    📁 server/routes/ocrSessions.js:427
    💬 Get OCR job results by jobId
    🛡️  Middleware: Check
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /secure/upload
    📁 server/routes/ocrSessions.js:300
    💬 Secure upload route for verified sessions
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /send
    📁 server/routes/social/notifications.js:588
    💬 POST /api/social/notifications/send - Send custom notification (admin only)
    🔗 113 references (4 frontend, 109 backend)

❓ 🔗 POST   /sendMessage
    📁 server/routes/mock-apis.js:60
    💬 Mock send message endpoint
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /server-metrics
    📁 server/routes/adminSystem.js:223
    💬 Server Metrics
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /service-catalog
    📁 server/routes/enhancedInvoices.js:749
    💬 GET /api/enhanced-invoices/service-catalog - Get available services
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /session
    📁 server/routes/debug.js:6
    💬 Debug endpoint to check session status (uncomment for debugging)
    🛡️  Middleware: check
    🔗 546 references (4 frontend, 542 backend)

❓ 🔗 POST   /session
    📁 server/routes/ocrSecure.js:81
    💬 /
    🔗 546 references (4 frontend, 542 backend)

❓ 🔗 GET    /session-continuity
    📁 server/routes/debug.js:142
    💬 Test endpoint to debug session continuity
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /session-full-debug
    📁 server/routes/debug.js:176
    💬 Comprehensive session debugging endpoint
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /session-status
    📁 server/routes/debug.js:221
    💬 🔧 SESSION DEBUG ENDPOINT - Shows session transmission details
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /session/:sessionId/disclaimer
    📁 server/routes/ocrSecure.js:99
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /session/:sessionId/results
    📁 server/routes/ocrSecure.js:132
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /session/:sessionId/status
    📁 server/routes/ocrSecure.js:93
    💬 /
    🛡️  Middleware: Check, check
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /session/:sessionId/upload
    📁 server/routes/ocrSecure.js:105
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /session/verify
    📁 server/routes/ocrSessions.js:141
    💬 Verify session with PIN (typically called from mobile/barcode scanner)
    🛡️  Middleware: Verify, verify
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /sessions
    📁 server/routes/analytics.js:34
    💬 Get all analytics sessions
    🔗 218 references (5 frontend, 213 backend)

❓ 🔗 POST   /sessions
    📁 server/routes/analytics.js:71
    💬 Start a new analytics session
    🔗 218 references (5 frontend, 213 backend)

❓ 🔗 GET    /sessions/:id
    📁 server/routes/analytics.js:50
    💬 Get a specific analytics session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /sessions/:id
    📁 server/routes/teaching.js:115
    💬 Update a teaching session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /sessions/:id
    📁 server/routes/teaching.js:143
    💬 Delete a teaching session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:id/cycle
    📁 server/routes/analytics.js:113
    💬 Run analytics cycle for a session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:id/end
    📁 server/routes/nlp.js:95
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:id/pause
    📁 server/routes/autonomy.js:113
    💬 Pause an autonomy session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /sessions/:id/performance
    📁 server/routes/autonomy.js:267
    💬 Get autonomy performance
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:id/report
    📁 server/routes/analytics.js:145
    💬 Generate report for a session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /sessions/:id/report
    📁 server/routes/autonomy.js:286
    💬 Generate autonomy report
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:id/resume
    📁 server/routes/autonomy.js:147
    💬 Resume an autonomy session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:id/stop
    📁 server/routes/autonomy.js:181
    💬 Stop an autonomy session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /sessions/:sessionId
    📁 server/routes/jit-terminal.js:187
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:sessionId/concepts
    📁 server/routes/teaching.js:230
    💬 Add a concept to a session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /sessions/:sessionId/feedback
    📁 server/routes/teaching.js:293
    💬 Get feedback for a session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sessions/:sessionId/feedback
    📁 server/routes/teaching.js:312
    💬 Add feedback to a session
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /sessions/cleanup
    📁 server/routes/ocrSessions.js:277
    💬 Clean up expired sessions (cron job endpoint)
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /sessions/start
    📁 server/routes/autonomy.js:63
    💬 Start a new autonomy session
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /set-dropdown-options
    📁 server/routes/dropdownOptions.js:29
    💬 POST /api/set-dropdown-options
    🔗 14 references (0 frontend, 14 backend)

❓ 🔗 GET    /settings
    📁 server/routes/backup.js:31
    💬 GET /api/backup/settings - Get backup settings
    🔗 193 references (4 frontend, 189 backend)

❓ 🔗 PUT    /settings
    📁 server/routes/backup.js:62
    💬 PUT /api/backup/settings - Update backup settings
    🔗 193 references (4 frontend, 189 backend)

❓ 🔗 POST   /settings
    📁 server/routes/bigbook.js:400
    💬 POST /api/bigbook/settings - Save Big Book settings
    🔗 193 references (4 frontend, 189 backend)

❓ 🔗 POST   /sources
    📁 server/routes/headlines-config.js:229
    💬 POST /api/headlines/sources - Add new source
    🔗 157 references (4 frontend, 153 backend)

❓ 🔗 GET    /sources
    📁 server/routes/headlines.js:119
    💬 GET /api/headlines/sources - Get available news sources
    🔗 157 references (4 frontend, 153 backend)

❓ 🔗 DELETE /sources/:id
    📁 server/routes/headlines-config.js:476
    💬 DELETE /api/headlines/sources/:id - Delete a source
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /sources/:id/test
    📁 server/routes/headlines-config.js:290
    💬 POST /api/headlines/sources/:id/test - Test a source
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /sources/bulk-update
    📁 server/routes/headlines-config.js:370
    💬 PUT /api/headlines/sources/bulk-update - Bulk update sources
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /sources/manage
    📁 server/routes/headlines-config.js:14
    💬 GET /api/headlines/sources/manage - Get all sources with management info
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /start
    📁 server/routes/autoLearningRoutes.js:28
    💬 /
    🔗 85 references (4 frontend, 81 backend)

❓ 🔗 POST   /start-session
    📁 server/routes/jit-terminal.js:78
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /start/:friendId
    📁 server/routes/social/chat.js:666
    💬 POST /api/social/chat/start/:friendId - Start conversation with friend
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /statistics
    📁 server/routes/church-scraper.js:207
    💬 Get statistics
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /statistics/geographical
    📁 server/scrapers/frontend/church-directory-api.js:173
    💬 3. Get geographical distribution
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /statistics/jurisdictions
    📁 server/scrapers/frontend/church-directory-api.js:151
    💬 2. Get jurisdiction statistics
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /statistics/quality
    📁 server/scrapers/frontend/church-directory-api.js:195
    💬 4. Get data quality metrics
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /stats
    📁 server/routes/admin/sessions.js:92
    💬 GET /api/admin/sessions/stats - Get session statistics
    🔗 17 references (4 frontend, 13 backend)

❓ 🔗 GET    /stats/summary
    📁 server/routes/records.js:103
    💬 GET /api/records/stats/summary - Get records statistics
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /status
    📁 server/routes/admin/nfs-backup.js:405
    💬 GET /api/admin/nfs-backup/status - Get detailed NFS status
    🔗 752 references (4 frontend, 748 backend)

❓ 🔗 GET    /status/:queueId
    📁 server/routes/provision.js:525
    💬 Get provision status
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /status/offline
    📁 server/routes/social/friends.js:554
    💬 POST /api/social/friends/status/offline - Update offline status
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /status/online
    📁 server/routes/social/friends.js:528
    💬 POST /api/social/friends/status/online - Update online status
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /stop
    📁 server/routes/autoLearningRoutes.js:35
    💬 /
    🛡️  Middleware: authenticate
    🔗 29 references (4 frontend, 25 backend)

❓ 🔗 GET    /storage
    📁 server/routes/backup.js:128
    💬 GET /api/backup/storage - Get storage information
    🔗 381 references (4 frontend, 377 backend)

❓ 🔗 GET    /storage/file/:fileId
    📁 server/routes/bigbook.js:1005
    💬 GET /api/bigbook/storage/file/:fileId - Retrieve file from encrypted storage
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /storage/file/:fileId
    📁 server/routes/bigbook.js:1037
    💬 DELETE /api/bigbook/storage/file/:fileId - Delete file from encrypted storage
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /storage/files
    📁 server/routes/bigbook.js:986
    💬 GET /api/bigbook/storage/files - List files in encrypted storage
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /storage/mount
    📁 server/routes/bigbook.js:1068
    💬 POST /api/bigbook/storage/mount - Mount encrypted volume
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /storage/rotate-key
    📁 server/routes/bigbook.js:1104
    💬 POST /api/bigbook/storage/rotate-key - Rotate encryption key
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /storage/status
    📁 server/routes/bigbook.js:967
    💬 GET /api/bigbook/storage/status - Get encrypted storage status
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /storage/unmount
    📁 server/routes/bigbook.js:1086
    💬 POST /api/bigbook/storage/unmount - Unmount encrypted volume
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /stream
    📁 server/routes/logs.js:210
    💬 GET /api/logs/stream - Server-Sent Events endpoint for real-time logs
    🔗 1311 references (4 frontend, 1307 backend)

❓ 🔗 POST   /submit-corrected-records
    📁 server/routes/ocr.js:587
    💬 Submit corrected multi-record results endpoint
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /submit-response
    📁 server/routes/bigbook.js:1123
    💬 POST /api/bigbook/submit-response - Submit questionnaire response
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /subscription
    📁 server/routes/billing.js:80
    💬 POST /api/billing/subscription - Create or update subscription
    🔗 813 references (4 frontend, 809 backend)

❓ 🔗 GET    /subscription/:churchId
    📁 server/routes/billing.js:54
    💬 GET /api/billing/subscription/:churchId - Get church subscription
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /summary
    📁 server/routes/componentDiscovery.js:90
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /summary/:churchId
    📁 server/routes/dashboard.js:6
    💬 Get dashboard summary for a church
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /summary/generate
    📁 server/routes/watchdog.js:378
    💬 /
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /sync
    📁 server/routes/templates.js:497
    💬 /
    🔗 121 references (4 frontend, 117 backend)

❓ 🔗 GET    /system-info
    📁 server/routes/admin/systemInfo.js:43
    💬 GET /api/admin/system-info - Get system information
    🛡️  Middleware: check
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /system-stats
    📁 server/routes/adminSystem.js:30
    💬 System Statistics
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /tasks
    📁 server/routes/calendar.js:18
    💬 Get all AI tasks
    🔗 81 references (4 frontend, 77 backend)

❓ 🔗 POST   /tasks
    📁 server/routes/calendar.js:92
    💬 Create new AI task
    🔗 81 references (4 frontend, 77 backend)

❓ 🔗 USE    /tasks
    📁 server/routes/kanban/index.js:10
    💬 Mount the sub-routers
    🛡️  Middleware: check
    🔗 81 references (4 frontend, 77 backend)

❓ 🔗 GET    /tasks/:id
    📁 server/routes/calendar.js:52
    💬 Get task by ID
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /tasks/:id
    📁 server/routes/calendar.js:153
    💬 Update existing task
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /tasks/:id
    📁 server/routes/calendar.js:246
    💬 Delete task
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /tasks/:id/sync
    📁 server/routes/kanbanSync.js:285
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /tasks/:id/sync-kanban
    📁 server/routes/calendar.js:585
    💬 Sync task with Kanban
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 DELETE /tasks/:id/sync-kanban
    📁 server/routes/calendar.js:633
    💬 Unsync task from Kanban
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /tasks/agent/:agent
    📁 server/routes/calendar.js:307
    💬 Get tasks by agent
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /tasks/bulk
    📁 server/routes/calendar.js:415
    💬 Bulk update tasks
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /tasks/priority/:priority
    📁 server/routes/calendar.js:379
    💬 Get tasks by priority
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /tasks/range
    📁 server/routes/calendar.js:267
    💬 Get tasks by date range
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /tasks/stats
    📁 server/routes/calendar.js:507
    💬 Get task statistics
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /tasks/status/:status
    📁 server/routes/calendar.js:343
    💬 Get tasks by status
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 USE    /teaching
    📁 server/routes/index.js:19
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /test
    📁 server/routes/admin/nfs-backup.js:314
    💬 POST /api/admin/nfs-backup/test - Test NFS connection
    🔗 1170 references (8 frontend, 1162 backend)

❓ 🔗 GET    /test
    📁 server/routes/baptism.js:48
    💬 Test endpoint to verify API is working
    🛡️  Middleware: verify
    🔗 1170 references (8 frontend, 1162 backend)

❓ 🔗 POST   /test-connection/:church_id
    📁 server/routes/churchSetupWizard.js:285
    💬 POST /api/churches/test-connection/:church_id - Test database connection
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /test-cookie
    📁 server/routes/debug.js:96
    💬 Debug endpoint to manually set and test cookies
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /test-ocr
    📁 server/routes/ocrVision.js:378
    💬 Test OCR route without authentication (for testing purposes)
    🔗 10 references (5 frontend, 5 backend)

❓ 🔗 POST   /test-secure-mount
    📁 server/routes/bigbook.js:622
    💬 POST /api/bigbook/test-secure-mount - Test encrypted storage mount
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /test-terminal
    📁 server/routes/jit-terminal.js:275
    💬 /
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /test-users
    📁 server/routes/admin.js:1121
    💬 Test endpoint to verify query works (disabled for production)
    🛡️  Middleware: verify
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /today
    📁 server/routes/orthodoxCalendar.js:196
    💬 Get today's Orthodox calendar data
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /toggle-mandatory
    📁 server/routes/permissions.js:71
    💬 ─── TOGGLE MANDATORY FIELD ─────────────────────────────────────────────────
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /translate/start
    📁 server/routes/ai.js:150
    💬 POST /api/ai/translate/start - AI translation
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /translation
    📁 server/routes/admin-test.js:24
    💬 Advanced Tests
    🔗 393 references (4 frontend, 389 backend)

❓ 🔗 GET    /translation-stats
    📁 server/routes/public/ocr.js:231
    💬 Get translation cost usage statistics
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /trends
    📁 server/routes/analytics.js:422
    💬 Get trend analyses
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /type/:recordType
    📁 server/routes/templates.js:331
    💬 /
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /types/record-types
    📁 server/routes/templates.js:600
    💬 /
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /unique-values
    📁 server/routes/baptism.js:400
    💬 GET /api/unique-values?table=…&column=…
    🔗 17 references (4 frontend, 13 backend)

❓ 🔗 POST   /unmount
    📁 server/routes/admin/nfs-backup.js:382
    💬 POST /api/admin/nfs-backup/unmount - Manually unmount NFS share
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /unread
    📁 server/routes/social/notifications.js:154
    💬 GET /api/social/notifications/unread - Get unread notifications count
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /update-permission
    📁 server/routes/permissions.js:92
    💬 ─── UPDATE USER PERMISSION ─────────────────────────────────────────────────
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /upload
    📁 server/routes/admin/globalImages.js:171
    💬 Upload global image
    🔗 322 references (5 frontend, 317 backend)

❓ 🔗 POST   /upload-image
    📁 server/routes/social/blog.js:742
    💬 POST /api/social/blog/upload-image - Upload blog image
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /upload-knowledge
    📁 server/routes/omai.js:1509
    💬 POST /api/omai/upload-knowledge - Upload knowledge file
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 POST   /upload-link
    📁 server/routes/uploadToken.js:9
    💬 Generate secure upload link (requires admin authentication)
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /upload-links
    📁 server/routes/uploadToken.js:108
    💬 List active upload links (admin only)
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 POST   /upload-parish-map
    📁 server/routes/bigbook.js:1617
    💬 /
    🛡️  Middleware: authenticate, authorize
    🔗 9 references (4 frontend, 5 backend)
...
❓ 🔗 USE    /uploads
    📁 server/index.js:478
    💬 --- STATIC FRONTEND ------------------------------------------------
    🔗 93 references (4 frontend, 89 backend)

❓ 🔗 GET    /user-permissions
    📁 server/routes/admin/menu-permissions.js:7
    💬 Get current user's menu permissions
    🔗 9 references (4 frontend, 5 backend)

❓ 🔗 GET    /user/:role
    📁 server/routes/menuPermissions.js:138
    💬 GET /api/menu-permissions/user/:role - Get menu items allowed for a specific role
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 GET    /user/:userId
    📁 server/routes/admin/social-permissions.js:7
    💬 Get user's social permissions
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 PUT    /user/:userId
    📁 server/routes/admin/social-permissions.js:67
    💬 Update user's social permissions
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /user/:userId/enable
    📁 server/routes/admin/social-permissions.js:135
    💬 Enable social features for specific users (individual user override)
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 USE    /users
    📁 server/routes/index.js:16
    💬 Mount routes
    🔗 334 references (5 frontend, 329 backend)

❓ 🔗 POST   /users/:id/reset-password
    📁 server/routes/admin.js:864
    💬 POST /admin/users/:id/reset-password - Reset user password
    🔗 14 references (0 frontend, 14 backend)

❓ 🔗 PATCH  /users/:id/reset-password
    📁 server/routes/admin.js:944
    💬 PATCH /admin/users/:id/reset-password - Reset user password with custom password
    🔗 14 references (0 frontend, 14 backend)

❓ 🔗 PATCH  /users/:id/status
    📁 server/routes/admin.js:1048
    💬 PATCH /admin/users/:id/status - Update user status
    🔗 7 references (0 frontend, 7 backend)

❓ 🔗 POST   /validate
    📁 server/routes/templates.js:295
    💬 /
    🛡️  Middleware: Validate, validate
    🔗 229 references (4 frontend, 225 backend)

❓ 🔗 GET    /validate-upload
    📁 server/routes/ocrSecure.js:87
    💬 /
    🛡️  Middleware: Validate, validate
    🔗 5 references (0 frontend, 5 backend)

❓ 🔗 GET    /verify-upload-token/:token
    📁 server/routes/uploadToken.js:57
    💬 Verify upload token
    🛡️  Middleware: Verify, verify
    🔗 4 references (0 frontend, 4 backend)

❓ 🔗 POST   /webhook
    📁 server/routes/billing.js:447
    💬 POST /api/billing/webhook - Stripe webhook handler
    🛡️  Middleware: Check
    🔗 145 references (0 frontend, 145 backend)

❓ 🔗 POST   /wizard-results
    📁 server/routes/ocr.js:581
